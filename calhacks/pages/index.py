...
from .. import styles
from ..templates import template
from ..app_state import AppState  # Assuming AppState is in app_state.py


@template(route="/", title="Navigational Guidance")
def index() -> rx.Component:
    """The main page displaying navigational guidance."""
    return rx.vstack(
        rx.heading("Navigational Guidance", size="2xl", text_align="center"),
        rx.box(
            rx.text(
                "Latest Summary:",
                size="lg",
        ...
        rx.heading("Past Summaries", size="xl", margin_top="2rem"),
        rx.box(
            rx.foreach(
